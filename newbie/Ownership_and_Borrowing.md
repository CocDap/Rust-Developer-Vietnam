...
***Tham chiếu không đổi và tham chiếu đổi**: Có hai loại "borring" trong Rust:
    + Tham chiếu không đổi (&): Cho phép bạn đọc dữ liệu mà không thay đổi nó. Bạn có thể có nhiều tham chiếu không đổi tới cùng một dữ liệu cùng một lúc.
    + Tham chiếu đổi (&mut): Cho phép bạn thay đổi dữ liệu. Chỉ có thể có một tham chiếu đổi tới một dữ liệu tại một thời điểm.
